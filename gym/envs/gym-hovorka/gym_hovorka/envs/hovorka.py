...
class HovorkaDiabetes(gym.Env):
    ...
    def __init__(self):
        ...
        # Observation space -- bg between 0 and 300, measured every five minutes (1440 mins per day / 5 = 288)
        self.observation_space = spaces.Box(0, 300, 288)
    ...
    def _step(self, action):
        ...
        # take a step with action -- run the simulation for one day with new bolus amount
